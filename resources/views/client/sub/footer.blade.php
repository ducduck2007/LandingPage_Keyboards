    ...
    <div class="container-fluid col-11 mt-4">
        <div class="col-12 pt-5 pb-4">
            <div class="row row-cols-4">
                <div class="col">
                    <div class="fw-bold fs-6">VỀ Đƚԋɳιҽɳ VHB</div>
                ...
                <div class="col">
                    <div class="fw-bold fs-6">CHÍNH SÁCH</div>
                    <div class="mucNho mt-3" style="font-size: 14px">muc1</div>
                    <div class="mucNho" style="font-size: 14px">muc2</div>
                    <div class="mucNho" style="font-size: 14px">muc3</div>
                </div>
        ...
        <div class="col-12" id="social-footer">
            <div class="card">
                <span>Social</span>
...
<style>
    ...
    #social-footer .card:hover::after {
        opacity: 0.5;
        transform: translateY(100%);
    }
    ...
    #social-footer .card .social-link {
        position: relative;
        display: flex;
        align-items: center;
        justify-content: center;
    ...
    #social-footer .card .social-link svg {
        text-shadow: 1px 1px rgba(31, 74, 121, 0.7);
        transform: scale(1);
    }

    #social-footer .card .social-link:hover {
