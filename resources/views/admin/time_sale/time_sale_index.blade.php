...
@section('content')
    <div class="page-title-box">
        <div class="row align-items-center ">
            <div class="col-md-8">
                <div class="page-title-box">
                    <h4 class="page-title">CÀI ĐẶT THỜI GIAN SALE</h4>
                    @if ($errors->any())
            ...
            <div class="card">
                <div class="card-body" style="padding-bottom: 0px!important;padding-top: 0px!important;">
                    <div class="form-group mb-0">
                        <div><br></div>
                        <a href="{{ route('time_sale.create') }}" name="create"
                                ...
                                <tbody>
                                    @foreach ($data as $d)
                                        <tr>
                                            ...
                                            <td>{{ \Carbon\Carbon::parse($d->time)->format('d/m/Y H:i:s') }}</td>
                                            <td>
                                                <a style="background-color: #3498db; border-color:#3498db;color:whitesmoke;"
                                                    href="{{ route('time_sale.update', ['id' => $d->id]) }}"
                                                    class="btn waves-effect waves-light">SỬA</a>
                                                <a href="{{ route('time_sale.delete') }}" value="{{ $d->id }}"
