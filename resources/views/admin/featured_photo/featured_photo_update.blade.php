        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-body" style="padding-top: 0px;">
                    <form action="{{ route('featured_photo.postUpdate', ['id' => $model->id]) }}" method="post"
                        ...
                        <div class="form-group row">
                            <label for="image" class="col-sm-2 control-label">Ảnh
                        ...
                        <div class="form-group mb-0">
                            <div>
                                <a style="background-color: #34495e; border-color:#34495e;color:whitesmoke;"
                                    href="{{ route('featured_photo.index') }}" class="btn waves-effect waves-light">
                                    QUAY LẠI
                                </a>
