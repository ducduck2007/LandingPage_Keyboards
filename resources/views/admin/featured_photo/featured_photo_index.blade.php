            ...
            <div class="card">
                <div class="card-body" style="padding-bottom: 0px!important;padding-top: 0px!important;">
                    <div class="form-group mb-0">
                        <div><br></div>
                        <a href="{{ route('featured_photo.create') }}" name="create"
        ...
        <div class=" table-page col-lg-12">
            <div class="card">
                <div class="card-body">
                    ...
                    @isset($data)
                        <p>Danh sách ảnh nổi bật phần sale</p>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a style="background-color: #3498db; border-color:#3498db;color:whitesmoke;"
                                                    href="{{ route('featured_photo.update', ['id' => $d->id]) }}"
                                                    class="btn waves-effect waves-light">SỬA</a>
                                                <a href="{{ route('featured_photo.delete') }}" value="{{ $d->id }}"
                ...
                bootbox.confirm({
                    ...
                    callback: function(result) {
                        if (result == true) {
                            $.ajax({
                                type: 'post',
                                url: '{{ route('featured_photo.delete') }}',
                                data: {
                                    id: id,
